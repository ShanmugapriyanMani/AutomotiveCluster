...
Item {
    ...
    Image {
        ...
        Image {
            ...
            onRotationChanged: {
                MyDBusServer.setEngineStarted(true);
                MyDBusServer.setEngineTemperatureRange(rotation);
                MyDBusServer.setEngineTemperature(rotation);
                console.log("Current needle angle: " + rotation);
            }
            ...
            Connections {
                ...
                // function onRpmStopingRangeChanged() {
                //     // console.log("rpm stop range changed:", MyDBusServer.rpmStopingRange);
                //     needleRotationSeqId2.stop();
                // }
            }
