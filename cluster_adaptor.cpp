 ...
 * Command line was: qdbusxml2cpp -m -a cluster_adaptor -i qobject.h /home/shanmugapriyan/Documents/InstrumentCluster/myservice.xml
 *
...
void DbusAdaptor::setRpm(int rpmValue)
{
    // handle method call experion.server.dbus.setRpm
    QMetaObject::invokeMethod(parent(), "setRpm", Q_ARG(int, rpmValue));
}

void DbusAdaptor::setSpeed(int speed)
{
    // handle method call experion.server.dbus.setSpeed
